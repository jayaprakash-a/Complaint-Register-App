...
public class AcademicComplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academic_complaints);
        final DatabaseReference academic = FirebaseDatabase.getInstance().getReference().child("/Academics Complaints").getRef();
        final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progressBarComp);
        progressBar.getIndeterminateDrawable().setColorFilter(0xFFFF0000, android.graphics.PorterDuff.Mode.MULTIPLY);
        academic.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(AcademicComplaints.this, R.layout.listitem, rowItems);
                ListView lv = (ListView) findViewById(R.id.listacad);
                lv.setAdapter(adapter);
                final ListView list = (ListView) findViewById(R.id.listacad);
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent1 = new Intent(AcademicComplaints.this, Complaint.class);
                        ...
                        intent1.putExtra("activity", "Academics Complaints");
                        startActivity(intent1);
                    }
                });
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(AcademicComplaints.this, R.layout.listitem, rowItems3);
                ListView lv1 = (ListView) findViewById(R.id.listView2Acad);
                lv1.setAdapter(adapter1);
                final ListView list1 = (ListView) findViewById(R.id.listView2Acad);
