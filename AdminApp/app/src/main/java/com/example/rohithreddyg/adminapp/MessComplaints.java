...
//        setSupportActionBar(toolbar);
        mess.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(MessComplaints.this, R.layout.listitem, rowItems);
                ListView lv = (ListView) findViewById(R.id.listmess);
                lv.setAdapter(adapter);
                final ListView list = (ListView) findViewById(R.id.listmess);
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent1 = new Intent(MessComplaints.this, Complaint.class);
                        ...
                        intent1.putExtra("activity", "Mess Complaints");
                        startActivity(intent1);
                    }
                });
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(MessComplaints.this, R.layout.listitem, rowItems3);
                ListView lv1 = (ListView) findViewById(R.id.listView2mess);
                lv1.setAdapter(adapter1);
                final ListView list1 = (ListView) findViewById(R.id.listView2mess);
